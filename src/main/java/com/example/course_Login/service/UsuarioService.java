...
public class UsuarioService {
    ...
    public static boolean validacaoCpf(Long cpf){
    ...
    /*public static String imprimeCPF(Usuario obj) {
        return(obj.getCpf().toString().substring(0, 3) + "." + obj.getCpf().toString().substring(3, 6) + "." +
                obj.getCpf().toString().substring(6, 9) + "-" + obj.getCpf().toString().substring(9, 11));
    }*/
